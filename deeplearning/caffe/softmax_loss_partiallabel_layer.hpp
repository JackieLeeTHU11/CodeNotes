...
class SoftmaxWithLossPartialLableLayer : public LossLayer<Dtype> {
 public:
   /**
    ...
    */
  explicit SoftmaxWithLossPartialLableLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "SoftmaxWithLossPartialLable"; }
 ...
 protected:
  /// @copydoc SoftmaxWithLossPartialLableLayer
