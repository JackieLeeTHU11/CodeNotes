...
class SoftmaxWithLossClassweightFiveclassLayer : public LossLayer<Dtype> {
 public:
   /**
    ...
    */
  explicit SoftmaxWithLossClassweightFiveclassLayer(const LayerParameter& param)
