...
if __name__ == "__main__":
    ...
    softmaxpolicy, y = sarsa(grid, evaler, softmaxpolicy, valuepolicy, 10000, 0.01)
    plt.plot(y, "-", label="sarsa")

    softmaxpolicy_ql, y_ql = sarsa(grid, evaler, softmaxpolicy, valuepolicy, 10000, 0.01)
    plt.plot(y_ql, "-", label="ql")
